...
const WebDesignCards = ({ img, title, desc, mobileImg }: Props) => {
  return (
    <>
      <div className="flex flex-col md:flex-row lg:flex-col inline-block md:hidden lg:block ">
        <div className="flex">
          <Image
        ...
        <div
          className={`${styles.container} mt-0 p-[32px] group hover:bg-[#E7816B] md:flex md:flex-col md:justify-center rounded-b-[15px] md:rounded-b-none lg:rounded-b-[15px] transition-all duration-300 ease-in-out`}
        >
          <h1
      ...
      <div className="flex flex-col md:flex-row lg:flex-col hidden md:inline-flex lg:hidden ">
        <Image
